                ...
                <ScrollView>
                    ...
                    <View style={{ alignSelf: 'center', marginTop: 20 }}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('paymentsuccess')}
                            style={{ height: 52, width: responsiveWidth(90), backgroundColor: '#808080', alignSelf: 'center', justifyContent: 'center', borderRadius: 30, marginTop: responsiveHeight(2) }}>
                            <LinearGradient
                            ...
                            >
                                <Text style={{ alignSelf: 'center', color: '#FFFFFF' }}>Payment</Text>
                            </LinearGradient>
                        </TouchableOpacity>
